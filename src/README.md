...
**Guardian** provides a simple way to authorize user actions against a given resource and using a clear and beauty sintaz for ACL validation. There are two primary ways of authorizing actions: gates and policies.
